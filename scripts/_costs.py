...
class Costs:
    ...
    def adjust(self):
        with st.form("5"):
            ...
            self.elprice = st.number_input("Juster stømpris [kr]", value = 1.0, min_value = 0.0, max_value = 20.0, step = 0.1)
            #self.payment_time = st.number_input("Juster nedbetalingstid [år]", value = 20, min_value = 1, max_value = 20, step = 1)

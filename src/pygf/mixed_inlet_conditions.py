...
def mixed_inlet_conditions_app():
    # -------------------------------------------------------------------------
    ...
    st.pyplot(gfunc_equal_Tf_mixed.visualize_temperatures())
    st.pyplot(gfunc_equal_Tf_mixed.visualize_temperature_profiles())
    st.pyplot(gfunc_equal_Tf_mixed.visualize_heat_extraction_rates())
    st.pyplot(gfunc_equal_Tf_mixed.visualize_heat_extraction_rate_profiles())
